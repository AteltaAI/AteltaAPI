...
- 🎯 Entry points to execute your program using `python -m <ateltaapi>` or `$ ateltaapi` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/AteltaAI/AteltaAPI/branch/main/graph/badge.svg?token=AteltaAPI_token_here)](https://codecov.io/gh/AteltaAI/AteltaAPI)
[![CI](https://github.com/AteltaAI/AteltaAPI/actions/workflows/main.yml/badge.svg)](https://github.com/AteltaAI/AteltaAPI/actions/workflows/main.yml)

Awesome ateltaapi created by AteltaAI

## Install

from source
```bash
git clone https://github.com/AteltaAI/AteltaAPI ateltaapi
cd ateltaapi
make install
```
...
```bash
pip install ateltaapi
```

## Executing

```bash
$ ateltaapi run --port 8080
```

or

```bash
python -m ateltaapi run --port 8080
```

or

```bash
$ uvicorn ateltaapi:app
```
...
```bash
❯ ateltaapi --help
Usage: ateltaapi [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ ateltaapi create-user --help
Usage: ateltaapi create-user [OPTIONS] USERNAME PASSWORD
...
```bash
ateltaapi create-user admin admin --superuser
```
...
Run with `ateltaapi run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `ateltaapi create-user`.
...
-----------------------------------------------------
ateltaapi/__init__.py              4      0   100%
ateltaapi/app.py                  16      1    94%
ateltaapi/cli.py                  21      0   100%
ateltaapi/config.py                5      0   100%
ateltaapi/db.py                   10      0   100%
ateltaapi/models/__init__.py       0      0   100%
ateltaapi/models/content.py       47      1    98%
ateltaapi/routes/__init__.py      11      0   100%
ateltaapi/routes/content.py       52     25    52%
ateltaapi/routes/security.py      15      1    93%
ateltaapi/routes/user.py          52     26    50%
ateltaapi/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in ateltaapi/default.toml.
